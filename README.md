...
I’m an MSc student in Quantum Technology who learns by wandering through ideas —  
...
- **Random Walk of a Knight**  
  A fun experiment where a chess knight performs a random walk on a grid.  
  (Because why should electrons have all the fun?)

### • Quantum & Device Physics  
- **Quantum Random Number Generator (QRNG)**  
  My hardware project using Zener diodes and tunneling noise.  
- **HOPG–MoS₂ Notes & Reports**  
  AFM, Raman, exfoliation, lithography — the whole messy adventure.

### • Scanning Probe & Nanotech  
...
If something confuses you — even better. Curious minds grow like that.

---

## 👋 About Me
I’m someone who loves to learn everything in the most chaotic, undisciplined, and original way possible.  
Physics is my playground, not a checklist.
